// ========================================================
// 描 述：UIBezierLine2.cs 
// 作 者： 
// 时 间：2020/03/26 10:52:47 
// 版 本：2019.2.1f1 
// ========================================================
// ========================================================
// 描 述：UIBezierLine.cs 
...
{
    public class UIBezierLine2 : RawImage {
        ...
        [SerializeField]
        private float m_dividerHeight = 0.25f;
        /// <summary>
        ///  路径点
        /// </summary>
        [SerializeField]
        ...
        public void Init () {
            this.m_pointController = new UIBezierLinePointController ();
