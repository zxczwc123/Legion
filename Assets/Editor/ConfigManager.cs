...
public class ConfigManager
{
    ...
    public static Dictionary<int, T> GetDict<T>()
    {
        ...
        if (configDict.ContainsKey(path)) return (Dictionary<int, T>) configDict[path];
    ...
    private static void CreateLegionConfig()
    {
        var config = ScriptableObject.CreateInstance<LegionConfig>();
        AssetDatabase.CreateAsset(config, "Assets/Resources/LegionConfig.asset");
